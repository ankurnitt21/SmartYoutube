        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $.each(data, function(index, value){   
                    ...
                    output += "<button type='button' class='btn btn-success timestamp ' value='" + value[key] + "'>" + '<i class="fa fa-play" aria-hidden="true"></i>&nbsp' +  '<span style="color:black;">' + key + "</span>" +   "</button>&nbsp";
